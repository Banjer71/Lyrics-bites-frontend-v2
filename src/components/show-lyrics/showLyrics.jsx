    ...
    return (
        <>
            <div style={{ position: "relative" }}>
                ...
                <div style={{ textAlign: "center", paddingBottom: "1rem" }}>Split the lyrics in verse and send each verse on a schedule time</div>
                <div className="split-btn">
                    <button onClick={() => scheduleSendSongViaMail(1, lyrics, _id, songTitle)}>Every day</button>
                    <button onClick={() => scheduleSendSongViaMail(3, lyrics, _id, songTitle)}>Every 3 days</button>
                    <button onClick={() => scheduleSendSongViaMail(2, lyrics, _id, songTitle)}>Every 2 days</button>
                </div>

                <div style={{ textAlign: "center", paddingBottom: "1rem" }}>At the moment this feature allow to schedule an email every 3 days</div>
